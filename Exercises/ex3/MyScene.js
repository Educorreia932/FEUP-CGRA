...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cube = new MyUnitCube(this, 5);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.63, 0.32, 0.18, 1.0);
        this.material4.setDiffuse(1.0, 1.0, 1.0, 1.0);
        this.material4.setSpecular(0.1, 0.1, 0.1, 0.1);
